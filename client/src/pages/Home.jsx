...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="text-center">
                    <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6">
                        Welcome to <span className="text-cyan-400">BlogSystem</span>
                    </h1>
                    ...
                    <div className="flex justify-center gap-4">
                        {user ? (
                            <>
                                <Link
                                    to="/create-blog"
                                    className="px-8 py-3 bg-cyan-400 text-gray-900 rounded-lg hover:bg-cyan-500 text-lg font-semibold shadow-lg"
                                >
                                    Create Your First Blog
                                </Link>
                                <Link
                                    to="/blogs"
                                    className="px-8 py-3 bg-gray-800 text-cyan-400 border-2 border-cyan-400 rounded-lg hover:bg-gray-700 text-lg font-semibold shadow-lg"
                                >
                                    Browse Blogs
                                </Link>
                            </>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-700">
            ...
            {!user && (
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl shadow-2xl p-12 text-center">
                        ...
                        <Link
                            to="/register"
                            className="inline-block px-8 py-3 bg-gray-900 text-cyan-400 rounded-lg hover:bg-gray-800 text-lg font-semibold shadow-lg"
                        >
                            Create Free Account
                        </Link>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    ...
                    <div className="bg-gray-800 rounded-lg shadow-md p-8 border border-gray-700">
                        <div className="text-4xl font-bold text-cyan-400 mb-2">10000+</div>
